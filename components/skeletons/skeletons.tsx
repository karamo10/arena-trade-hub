...
//   return (
//     <div className="flex items-center flex-col md:flex-row py-1 bg-red-600 shadow-lg rounded relative animate-pulse">
//       {/* Image skeleton */}
//       <div className="relative w-[100px] h-[100px] md:w-[120px] md:h-[120px] rounded bg-gray-300" />

//       {/* Text skeletons */}
//       <div className="text-center px-2 flex flex-col items-center md:items-start">
//         <div className="h-3 w-24 md:w-32 bg-gray-300 rounded mb-2" />{' '}
//         {/* product name */}
//         <div className="h-3 w-16 md:w-20 bg-gray-300 rounded" /> {/* price */}
//       </div>

//       {/* Stock status skeleton */}
//       <div className="h-2 w-12 bg-gray-300 rounded absolute top-0 right-1" />
//     </div>
//   );
// }
